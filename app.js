...
function wine() {
  for (var i = 0; i < 4; i++) {
    var wine = parseInt(prompt('What year is the oldest bottle of wine or port I have in my cellar? You\'ve used ' + i + ' of 4 guesses.'));
...
function soccer() {
  ...
  // evaluate flag
    if (flag === 1) {
      ...
      var guesses = socGuesses + 1;
      alert('Nope. You\'ve used ' + guesses + ' of 6 guesses.');
    }
  }
}
soccer();
...
alert('You answered ' + correctCounter + ' of the 7 questions correctly. Well done.');
